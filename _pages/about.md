...
I am currently an M.S. student in **Computer Technology** at [Shenzhen University](https://www.szu.edu.cn/). Before that, I received my B.S. in **Information and Computational Science** from **Guangdong University of Technology**. My research develops intelligent systems for complex physical and spatial environments through an AI-driven interdisciplinary approach.
...
<div class="paper-box">
  <div class="paper-box-image"><img src="{{ '/images/research/mspno-method.jpg' | relative_url }}" alt="MSPNO method thumbnail"></div>
  <div class="paper-box-text">
    <strong>MSPNO: Spherical Physics-informed Neural Operator for Meteorological Downscaling</strong><br>
...
- Email: [yaniszz085@gmail.com](mailto:yaniszz085@gmail.com)
- CV: [Yiqiang-Ye-CV-EN.pdf]({{ '/files/Yiqiang-Ye-CV-EN.pdf' | relative_url }})
